...
**Required evidence**:
- Logic: `tests/unit/status-effect-system/status-effect-system-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/status-effect-system/status-effect-system-system-integration_test.gd` OR playtest doc
