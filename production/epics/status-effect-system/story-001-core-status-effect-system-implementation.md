...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/status-effect-system/core-status-effect-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/status-effect-system/core-status-effect-system-implementation_test.gd` OR playtest doc
