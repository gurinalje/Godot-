...
*From GDD `design/gdd/narrative-system.md`, scoped to this story:*
...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/narrative-system/core-narrative-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/narrative-system/core-narrative-system-implementation_test.gd` OR playtest doc
