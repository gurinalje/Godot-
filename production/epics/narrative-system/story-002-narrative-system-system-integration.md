# Story 002: narrative-system System Integration
...
**Requirement**: `TR-narrative-system-002`
...
**Required evidence**:
- Logic: `game/tests/unit/narrative-system/narrative-system-system-integration_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/narrative-system/narrative-system-system-integration_test.gd` OR playtest doc
- Visual/Feel: `production/qa/evidence/narrative-system-system-integration-evidence.md` + sign-off
