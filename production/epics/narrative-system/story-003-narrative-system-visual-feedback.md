...
**Required evidence**:
- Logic: `tests/unit/narrative-system/narrative-system-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/narrative-system/narrative-system-visual-feedback_test.gd` OR playtest doc
