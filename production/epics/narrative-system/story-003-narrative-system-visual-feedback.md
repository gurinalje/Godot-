# Story 003: narrative-system Visual Feedback
...
**Requirement**: `TR-narrative-system-003`
...
**Required evidence**:
- Logic: `game/tests/unit/narrative-system/narrative-system-visual-feedback_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/narrative-system/narrative-system-visual-feedback_test.gd` OR playtest doc
- Visual/Feel: `production/qa/evidence/narrative-system-visual-feedback-evidence.md` + sign-off
