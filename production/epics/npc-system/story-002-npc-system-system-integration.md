...
**Required evidence**:
- Logic: `tests/unit/npc-system/npc-system-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/npc-system/npc-system-system-integration_test.gd` OR playtest doc
