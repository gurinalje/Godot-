# Story 002: npc-system System Integration
...
*From GDD `game/design/gdd/npc-system.md`, scoped to this story:*
...
**Required evidence**:
- Logic: `game/tests/unit/npc-system/npc-system-system-integration_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/npc-system/npc-system-system-integration_test.gd` OR playtest doc
- Visual/Feel: `production/qa/evidence/npc-system-system-integration-evidence.md` + sign-off
