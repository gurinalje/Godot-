...
> **Status**: Ready
> **Stories**: Not yet created — run `/create-stories npc-system`

## Overview

This epic implements the npc-system system as defined in the GDD.
...
|-------|-------------|--------------|
| TR-npc-system-001 | Core implementation | ADR-0001 ✅ |
| TR-npc-system-002 | Integration with dependent systems | ADR-0002 ✅ |
