# Story 003: npc-system Visual Feedback
...
**Required evidence**:
- Logic: `game/tests/unit/npc-system/npc-system-visual-feedback_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/npc-system/npc-system-visual-feedback_test.gd` OR playtest doc
- Visual/Feel: `production/qa/evidence/npc-system-visual-feedback-evidence.md` + sign-off
