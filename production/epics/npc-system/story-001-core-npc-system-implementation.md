...
**Story Type**: Logic
**Required evidence**:
- Logic: `game/tests/unit/npc-system/core-npc-system-implementation_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/npc-system/core-npc-system-implementation_test.gd` OR playtest doc
