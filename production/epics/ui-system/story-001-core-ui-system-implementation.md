...
*From GDD `design/gdd/ui-system.md`, scoped to this story:*
...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/ui-system/core-ui-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/ui-system/core-ui-system-implementation_test.gd` OR playtest doc
