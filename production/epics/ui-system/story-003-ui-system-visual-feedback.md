...
**Required evidence**:
- Logic: `tests/unit/ui-system/ui-system-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/ui-system/ui-system-visual-feedback_test.gd` OR playtest doc
