...
**Required evidence**:
- Logic: `tests/unit/damage-calculation/damage-calculation-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/damage-calculation/damage-calculation-visual-feedback_test.gd` OR playtest doc
