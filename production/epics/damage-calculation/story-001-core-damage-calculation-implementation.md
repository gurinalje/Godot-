...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/damage-calculation/core-damage-calculation-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/damage-calculation/core-damage-calculation-implementation_test.gd` OR playtest doc
