...
**Required evidence**:
- Logic: `tests/unit/audio-system/audio-system-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/audio-system/audio-system-visual-feedback_test.gd` OR playtest doc
