...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/audio-system/core-audio-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/audio-system/core-audio-system-implementation_test.gd` OR playtest doc
