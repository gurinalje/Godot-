...
**Required evidence**:
- Logic: `tests/unit/card-database/card-database-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/card-database/card-database-system-integration_test.gd` OR playtest doc
