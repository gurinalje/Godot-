...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/card-database/core-card-database-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/card-database/core-card-database-implementation_test.gd` OR playtest doc
