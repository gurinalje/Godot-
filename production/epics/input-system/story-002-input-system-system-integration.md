...
**Required evidence**:
- Logic: `tests/unit/input-system/input-system-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/input-system/input-system-system-integration_test.gd` OR playtest doc
