...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/card-battle-system/core-card-battle-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/card-battle-system/core-card-battle-system-implementation_test.gd` OR playtest doc
