...
**Required evidence**:
- Logic: `tests/unit/card-battle-system/card-battle-system-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/card-battle-system/card-battle-system-system-integration_test.gd` OR playtest doc
