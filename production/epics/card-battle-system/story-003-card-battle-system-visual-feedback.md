...
**Required evidence**:
- Logic: `tests/unit/card-battle-system/card-battle-system-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/card-battle-system/card-battle-system-visual-feedback_test.gd` OR playtest doc
