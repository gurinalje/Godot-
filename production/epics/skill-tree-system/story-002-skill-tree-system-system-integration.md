...
**Required evidence**:
- Logic: `tests/unit/skill-tree-system/skill-tree-system-system-integration_test.gd` — must exist and pass
- Integration: `tests/integration/skill-tree-system/skill-tree-system-system-integration_test.gd` OR playtest doc
