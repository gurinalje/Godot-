...
**Story Type**: Logic
**Required evidence**:
- Logic: `game/tests/unit/skill-tree-system/core-skill-tree-system-implementation_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/skill-tree-system/core-skill-tree-system-implementation_test.gd` OR playtest doc
