...
**Required evidence**:
- Logic: `tests/unit/summon-system/summon-system-visual-feedback_test.gd` — must exist and pass
- Integration: `tests/integration/summon-system/summon-system-visual-feedback_test.gd` OR playtest doc
