...
**Required evidence**:
- Logic: `game/tests/unit/summon-system/summon-system-system-integration_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/summon-system/summon-system-system-integration_test.gd` OR playtest doc
