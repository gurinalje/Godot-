...
**Story Type**: Logic
**Required evidence**:
- Logic: `game/tests/unit/summon-system/core-summon-system-implementation_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/summon-system/core-summon-system-implementation_test.gd` OR playtest doc
