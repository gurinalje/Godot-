...
> **Status**: Ready
> **Stories**: Not yet created — run `/create-stories summon-system`
...
|-------|-------------|--------------|
| TR-summon-system-001 | Core implementation | ADR-0001 ✅ |
| TR-summon-system-002 | Integration with dependent systems | ADR-0002 ✅ |
