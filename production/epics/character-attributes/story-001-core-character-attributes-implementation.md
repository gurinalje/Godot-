...
**Story Type**: Logic
**Required evidence**:
- Logic: `game/tests/unit/character-attributes/core-character-attributes-implementation_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/character-attributes/core-character-attributes-implementation_test.gd` OR playtest doc
