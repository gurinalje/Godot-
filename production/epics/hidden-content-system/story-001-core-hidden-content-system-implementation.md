...
**Story Type**: Logic
**Required evidence**:
- Logic: `tests/unit/hidden-content-system/core-hidden-content-system-implementation_test.gd` — must exist and pass
- Integration: `tests/integration/hidden-content-system/core-hidden-content-system-implementation_test.gd` OR playtest doc
