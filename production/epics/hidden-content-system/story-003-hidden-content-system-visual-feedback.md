...
**Required evidence**:
- Logic: `game/tests/unit/hidden-content-system/hidden-content-system-visual-feedback_test.gd` â€?must exist and pass
- Integration: `game/tests/integration/hidden-content-system/hidden-content-system-visual-feedback_test.gd` OR playtest doc
