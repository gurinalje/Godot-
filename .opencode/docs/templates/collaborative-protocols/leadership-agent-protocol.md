...
**Example â€?strategic decision (after full analysis in conversation):**

  question with questions:
    1. question: "How should we handle crafting scope for Alpha?"
       header: "Scope"
       options:
         "Simplify to Core (Recommended)" â€?makes deadline, pillar visible
         "Full Implementation" â€?slips Alpha by 1 week
         "Cut Entirely" â€?deadline met, pillar missing
```
