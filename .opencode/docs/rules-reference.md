...
| `engine-code.md` | `game/src/core/**` | Zero allocs in hot paths, thread safety, API stability |
...
| `design-docs.md` | `game/design/gdd/**` | Required 8 sections, formula format, edge cases |
