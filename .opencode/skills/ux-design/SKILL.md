...
**If no argument is provided**, do not fail â€?ask instead. Use `question`:
...
- **Game concept**: Read `game/design/gdd/game-concept.md` â€?if missing, warn:
...
Glob `game/design/gdd/*.md` and grep for `UI Requirements` sections. Read any GDD whose
