...
|-----------|---------|---------|
| â‰?0% | **PASS** | On Track â€?within acceptable variance |
| 10â€?5% | **CONCERNS** | Minor Creep â€?manageable with targeted cuts |
| 25â€?0% | **FAIL** | Significant Creep â€?must cut or formally extend timeline |
...
- **CONCERNS** â†?offer to identify the 2â€? additions with best cut ratio. Reference `/sprint-plan update` to formally re-scope.
