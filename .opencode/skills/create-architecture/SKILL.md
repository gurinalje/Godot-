...
1. `game/design/gdd/game-concept.md` �?game pillars, genre, core loop
2. `game/design/gdd/systems-index.md` �?all systems, dependencies, priority tiers
3. `.opencode/docs/technical-preferences.md` �?naming conventions, performance budgets,
   allowed libraries, forbidden patterns
4. **Every GDD in `game/design/gdd/`** �?for each, extract technical requirements:
